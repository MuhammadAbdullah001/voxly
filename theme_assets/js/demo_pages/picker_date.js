...
var DateTimePickers = function() {
    ...
    var _componentPickadate = function() {
        ...
        $('.pickadate-limits-attendance').pickadate({
            min: [1990,1,1],
            max: [today],
        ...
        // $('.pickadate-limits-attendance').val(rangeDemoConv.format(new Date())).trigger('change');
    ...
    var _componentAnytime = function() {
        ...
        //custom made
        $('#anytime-month-numeric_end').AnyTime_picker({
            format: '%Z/%m/%d'
        });


        $('#anytime-month-numeric_start').AnyTime_picker({
            format: '%Z/%m/%d'
        });
        //end custom made
        // Month and day
