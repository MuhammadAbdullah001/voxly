...
var ChatLayouts = function() {
    ...
    var _layoutChat = function() {
        ...
        // $(".media-chat-scrollable").animate({
        //     scrollTop: $('.media-chat-scrollable')[0].scrollHeight - $('.media-chat-scrollable')[0].clientHeight
        // }, 1000);
        //
        if($(".media-chat-scrollable")[0] !== undefined){
            $(".media-chat-scrollable").scrollTop($('.media-chat-scrollable')[0].scrollHeight - $('.media-chat-scrollable')[0].clientHeight);
        }
	};
