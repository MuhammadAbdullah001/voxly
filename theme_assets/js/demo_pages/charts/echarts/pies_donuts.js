...
var EchartsPiesDonuts = function() {
    ...
    var _piesDonutsExamples = function() {
        ...
        var free_booking_pie_element = document.getElementById('booking_pie');
        // var pie_basic_element_lead_booking = document.getElementById('pie_basic_lead_booking');
        ...
        if (pie_basic_element) {
            ...
            $.ajax({
                ...
                url: '/admin/getBranchAndBookingForChart',
                type: 'get',
                datatype: 'json',
                    ...
                    if (data) {
                        ...
                        pie_basic.setOption({
                            ...
                            title: {
                                ...
                                subtext: 'Upcomming Booking information',
                                left: 'center',
                                textStyle: {
                                    fontSize: 17,
                                    fontWeight: 500
        ...
        if (free_booking_pie_element) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data) {
                        var free_booking_pie = echarts.init(free_booking_pie_element);
                        console.log(JSON.stringify(data));
                        var ammountAvailable = 0;
                        if(data["ammount_available"] > 0)
                            ammountAvailable = data["ammount_available"];
                        free_booking_pie.setOption({
                            ...
                            title: {
                                text: 'Booking data',
                                subtext: 'Booking credit for current month',
                                left: 'center',
                                textStyle: {
                                    fontSize: 17,
                                    fontWeight: 500
                            ...
                            series: [{
                                ...
                                data: [
                                    ...
                                    {value: ammountAvailable, name: data[1][0]},
                                ]
                            }]
                        });
                    }
        ...
        //pie for lead booking page

        // if (pie_basic_element_lead_booking) {
        //
        //     var branches = [];
        //
        //     $.ajax({
        ...
        //         success: function (data) {
        //             if (data) {
        //                 var pie_basic_lead_booking = echarts.init(pie_basic_element_lead_booking);
        //
        //                 for (index = 0; index < data.length; ++index) {
        //                     branches.push(data[index].name)
        //                 }
        //
        //
        //                 pie_basic_lead_booking.setOption({
        //
        //                     // Colors
        //                     color: [
        //                         '#2ec7c9', '#b6a2de', '#5ab1ef', '#ffb980', '#d87a80',
        ...
        var triggerChartResize = function() {
            ...
            free_booking_pie_element && free_booking_pie.resize();
