        ...
        <div class="page-header page-header-light">
            <div class="page-header-content header-elements-md-inline">
                <div class="page-title d-flex">
                    <h4><span class="font-weight-semibold">Classes/Groups</span> - Edit</h4>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="header-elements-inline">
                        <h4 class="card-title">Edit Classes/Groups</h4>
                    </div>
                </div>
                <hr>
                    ...
                    <form action="{{url('admin/group/edit')}}" method="post">
                       ...
                       <input type="hidden" name="id" value="<?php echo $d->id; ?>">
                        ...
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label">Classes/Groups:</label>
                            <div class="col-md-10">
                                <input type="text" value="<?php echo $d->name; ?>"    id="group_name"   name="name" class="form-control" placeholder="Enter Admission No" required>
                            </div>
                        </div>
