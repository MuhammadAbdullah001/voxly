        ...
        <!-- Basic datatable -->
            <div class="card">
                ...
                <table class="table datatable-basic  table-bordered">
                    ...
                    <tbody>
                    <?php if(isset($data['expenses']) && count($data['expenses']) > 0){ foreach($data['expenses']  as $d){ ?>
                    <tr <?php if (isset($d->is_update) && $d->is_update == 1){ ?> class="bg bg-warning" <?php } ?>>
                        <td>{{$d->id }}</td>
                        <td>{{$d->expense_category_name }}</td>
                        <td>{{ ucfirst(str_replace('_',' ',$d->expenseCategory->type)) }}</td>
                            ...
                            <div class="list-icons">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <a href="<?php echo url('admin/expenses/edit/' . $d->id); ?>"
                                           class="dropdown-item"><i class="icon-pencil3"></i> Edit</a>
