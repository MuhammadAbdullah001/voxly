        ...
        <div class="content">
            ...
            <div class="card">
                <div class="card-header header-elements-sm-inline">
                    <h6 class="card-title text-center">All Users List</h6>
                    ...
                    <div class="d-flex align-items-center mb-3 mb-md-0">
                        ...
                        <div class="ml-3" >
                            <h5 class="font-weight-semibold mb-0">
                                <?php if (isset($data['notification']) && !empty($data['notification'])){ ?>
                        {{count($data['notification']->notification_receivers )}}
                             <?php   }else{
                                   echo '0';
                                   }
                                    ?>
                ...
                <div class="table-responsive">
                    <table class="table mb-5 table datatable-basic-desc">
                        ...
                        <tr>
                            <th>#</th>
                            <th>Date</th>
                            <th>Admission Number/Staff Members</th>
                            <th>Parent Name/Staff Members</th>
                        ...
                        @if(isset($data['notification']))
                            <?php $count = 1; ?>
                         @foreach($data['notification']->notification_receivers as $notification_receiver)
                            <tr>
                                <td>
                                    {{ $count }}
                                </td>
                                <td>
                                    {{date('d-m-Y',strtotime($notification_receiver->created_at))}}
                                </td>
                                <td>
                                    @if(isset($notification_receiver->user->admission_no) && !empty($notification_receiver->user->admission_no))
                                    {{ $notification_receiver->user->admission_no}}
                                        @else
                                    {{ 'Staff' }}
                                        @endif
                                 </td>
                                <td>
                                    {{ $notification_receiver->user->parent_name}}
                                </td>
                                ...
                                <td>
                                    <div class="list-icons">
                                        <div class="list-icons-item dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a href="{{url('admin/response-check/'.$notification_receiver->users_id.'/'.$notification_receiver->notifications_id )}}" class="dropdown-item"><i class="icon-undo"></i> Response Check</a>
