        ...
        <div class="page-header page-header-light">
            <div class="page-header-content header-elements-md-inline">
                <div class="page-title d-flex">
                    <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Communication</span> - Parent List</h4>
                                    ...
                                    <td>
                                        <div class="list-icons">
                                            <div class="list-icons-item dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a href="{{url('admin/associatedParentCommunication/'.$user->id.'/'.$user->teacher_id )}}" class="dropdown-item"><i class="icon-undo"></i>  Related Chat</a>
