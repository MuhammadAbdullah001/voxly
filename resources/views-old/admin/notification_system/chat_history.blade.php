                ...
                <div class="card w-100 h-100 position-relative">
                    <div class="card-header bg-dark">
                        <div class="text-center">
                            <h5 class="card-title d-inline-block"> History Super-Admin: <span class="text-info">

                                {{$data['teacher_name']}}
                            </span></h5>
                            <h5 class="card-title d-inline-block"> & {{ucfirst($data['user_role'])}}: <span class="text-info">
                            ...
                            @if(isset($data['notifications']))
                                ...
                                @foreach($data['notifications'] as $notification)
                                    ...
                                    <li class="media">
                                        ...
                                        <!--<div class="media-chat-item">{{$notification->description}}</div>-->
