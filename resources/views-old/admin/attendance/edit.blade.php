        ...
        <div class="content">
            ...
            <div class="card">
                <div class="card-header header-elements-inline">
                    <h5 class="card-title">Edit Attendance (Student)</h5>
                ...
                <div class="card-body">
                    ...
                    ?>
                    <form action="{{url('admin/attendance/edit')}}" method="post">
                        @csrf
                        ...
                        <fieldset class="mb-3">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <div class="input-group">
                                        <select   class="form-control select" name="admission_no" id="admission_attendance">



                                            <option selected value="<?php  echo $d->admission_no; ?>"><?php echo $d->admission_no.' - '; echo $d->parent->parent_name; ?> </option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <div class="input-group">
                                        <select class="js-example-basic-single form-control js-example-theme-single select" id=" " name="student_admissions_id">
                                             <option selected value="<?php  echo $d->student_admissions_id; ?>"><?php  echo $d->student->student_name; ?> </option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-4">
                                    <div class="input-group">
                                        ...
                                        ?>
                                        <input type="text" name="end_time" class="form-control " id="anytime-time-start" placeholder="--Please Select--"  value="<?= $end_start; ?>" >
