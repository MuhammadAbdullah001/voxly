        ...
        <div class="page-header page-header-light">
            <div class="page-header-content header-elements-md-inline">
                <div class="page-title d-flex">
                    <h4><span class="font-weight-semibold">Expenses </span> - Add</h4>
        ...
        <div class="content">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{url('admin/expenses/add')}}" method="post">
                        @csrf
                        ...
                        <div class="form-group required row">
                            <label class="col-form-label col-lg-2 control-label">Expense Category Name</label>
                            <div class="col-lg-10">
                                <div class="input-group">
                        ...
                        <div class="form-group required row">
                            ...
                            <div class="col-md-10">
                                <input type="number"   id=""   value="{{ old('amount') }}"  name="amount" class="form-control" placeholder="Enter Expense Amount" required>
                            </div>
                        </div>

                        <div class="form-group required row">

                            <label class="col-md-2 col-form-label control-label">Expense Date:</label>
                            <div class="col-md-10">
                                <input type="text" id="date" value="{{ old('date') }}"  name="date" class="pickadate-limits-attendance form-control picker__input" required>
                            </div>
