		...
		<div class="page-header page-header-light">
			<div class="page-header-content header-elements-md-inline">
				<div class="page-title d-flex">
					<h4><span class="font-weight-semibold">Classes/Groups</span> - Main</h4>
			...
			<div class="card">
				<div class="card-header header-elements-inline">
					...
					<div class="header-elements">
						<a href="{{asset('/admin/group/add')}}" class="btn btn-primary legitRipple">Add New</a>
					</div>
				</div>


				<table id="group-table" style="width:100%" class="table table-responsive table-bordered">
					<thead>
					<tr>
						<th>#</th>
						<th>Name</th>
					...
					<tbody>
                    <?php if(isset($data['groups']) && count($data['groups'])>0){ foreach($data['groups']  as $d){ ?>
							...
							<div class="list-icons">
								<div class="dropdown">
									...
									<div class="dropdown-menu dropdown-menu-right">
										...
										<a href="<?php echo url('admin/group/edit/'.$d->id); ?>" class="dropdown-item"><i class="icon-pencil3"></i> Edit</a>
