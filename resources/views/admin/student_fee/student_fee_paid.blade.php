        ...
        <div class="content">
            ...
            <div class="card">
                ...
                <table class="table datatable-basic-desc table table-responsive table-bordered">
                    ...
                    <tbody>
                        <?php //dd($data['students_name_id_combo']); ?>
                    <?php if(isset($data['student_fees']) && count($data['student_fees'])>0){ foreach($data['student_fees']  as $d){   ?>
                        <?php if(isset($data['students_name_id_combo'][$d->student_admissions_id])){ $student_name = $data['students_name_id_combo'][$d->student_admissions_id]; ?>
