                ...
                <div class="card-body">
                    ...
                    <form action="{{url('admin/admission/add')}}" method="post">
                        ...
                        <div class="form-group row  " id="phone_number control-label">
                            <label class="col-form-label col-lg-2 ">Emergency Contact Number With Name</label>
                            <div class="col-lg-10">
                                <div class="input-group">
                                    <input type="text" name="emergency_contact_no" value="{{ old('emergency_contact_no') }}" id="emergency_contact_number" class="form-control" placeholder="Emergency Contact Number With Name"   >
                                </div>
                            </div>
                        </div>
