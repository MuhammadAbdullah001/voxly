        ...
        <div class="page-header page-header-light">
            <div class="page-header-content header-elements-md-inline">
                <div class="page-title d-flex">
                    <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Communication Between Teacher & Parent</span> </h4>
...
{{--                        <span class="breadcrumb-item active">Communication</span>--}}
{{--                    </div>--}}
        ...
        <div class="content">
            ...
            <div class="card">
                <div class="card-header header-elements-sm-inline">
                    <h6 class="card-title text-center">All Teachers List</h6>
                    ...
                    <table class="table mb-5 table datatable-basic-desc">
                        ...
                        <?php if(isset($data['teachers'])){
                            foreach($data['teachers'] as $teacher){
                                if (isset($teacher->teacherAssignedSub) && !empty($teacher->teacherAssignedSub)){
                                ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        {{ $teacher->teacherAssignedSub->subjects_name  }}
                                    </td>
                                    <td>
                                        {{ $teacher->teacherAssignedSub->assigned_group  }}
                                    </td>
                                    ...
                                    <td>
                                        <div class="list-icons">
                                            <div class="list-icons-item dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a href="{{url('admin/associated-parents/'.$teacher->id )}}" class="dropdown-item"><i class="icon-undo"></i> Parents List</a>
