                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <div class="input-group">
                                        <input type="text" class="form-control" readonly value="<?=$attendence_fixed->employee_name; ?>">
...
<!--                            </div>-->
                        ...
                        <?php
                        $permission = $this->User_Model->single_feild('permission',array('id'=>$this->session->userdata('admin_user_id')));

                        if($permission == 1 && $attendence_fixed->approved == 0){ ?>
                            <form action="  " method="POST">
                                <div class="row">
                                    <div class="col-md-2 col-md-offset-8">
                                        <a href="<?=base_url()?>index.php/AttendenceFixed/attendence_order_status/<?=$attendence_fixed->id?>/1" class="btn btn-primary" type="submit">Accepted</a>
                                    </div>
                                    <div class="col-md-4 col-md-offset-8">
                                        <a href="<?=base_url()?>index.php/AttendenceFixed/attendence_order_status/<?=$attendence_fixed->id?>/2" class="btn btn-danger" type="submit">Rejected</a>
                                    </div>
                                </div>
                            </form>
                        <?php } ?>
